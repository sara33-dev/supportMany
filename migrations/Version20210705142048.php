 ...
 */
final class Version20210705142048 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, speaker_id INT NOT NULL, tchat_id INT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_B6BD307FD04A0F27 (speaker_id), INDEX IDX_B6BD307FCACEEE58 (tchat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FD04A0F27 FOREIGN KEY (speaker_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FCACEEE58 FOREIGN KEY (tchat_id) REFERENCES room (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307FD04A0F27');
